...
const staffList: GitHubUser[] = [
    { name: 'Brady', github: 'ZeroMemes', role: Role.HeadDeveloper, blurb: 'Brady is the origonal developer of Impact, over 90% of the code has been dumped out of his anus.' },
    { name: 'LeafHacker', github: 'LeafHacker', role: Role.Developer, blurb: 'Leaf has been contributing to the Impact community since 2.7 and has helped with development since 4.1' },
    { name: 'leijurv', github: 'leijurv', role: Role.Developer, blurb: 'leijurv created baritone, the advanced AI for minecraft. In his spare time he fixes Leaf\'s and Brady\'s Impact bugs' },
...
function tileSize(role: Role): number {
    switch (role) {
        case Role.HeadDeveloper: return 4;
        case Role.Developer: return 2;
        default: return 1;
    }
}
